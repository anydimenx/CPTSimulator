...
//dynamic ticl4 pulse class

public class DynamicPulse implements Field, DefNum {
	private int recnt = 1;
	...
	public int loadPic(int index, double x, double y) {
		...
		if (recnt < 10) {
			name0 = "images/dynamicPulse/a3_" + "000" + recnt + ".bmp";
		} else if (10 <= recnt && recnt < 100) {
			name0 = "images/dynamicPulse/a3_" + "00" + recnt + ".bmp";
		} else if (100 <= recnt && recnt < 1000) {
			name0 = "images/dynamicPulse/a3_" + "0" + recnt + ".bmp";
		} else {
			name0 = "images/dynamicPulse/a3_" + "error" + ".bmp";
		}
